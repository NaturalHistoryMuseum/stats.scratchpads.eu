 ...
 * on Wed, 23 Sep 2015 13:46:32 +0100.
 *
...
if (isset($_SERVER['db_name'])) {
  ...
  */
  ...
  $conf['file_directory_path'] = 'sites/stats.scratchpads.eu/files';
  $conf['file_directory_temp'] = 'sites/stats.scratchpads.eu/private/temp';
  $conf['clean_url'] = 1;
  $conf['aegir_api'] = 3;
...
# Extra configuration from modules:
  ...
  if (is_readable('/var/aegir/platforms/stats.scratchpads.eu/sites/stats.scratchpads.eu/local.settings.php')) {
    include_once('/var/aegir/platforms/stats.scratchpads.eu/sites/stats.scratchpads.eu/local.settings.php');
  }
